...
public class BackupCommand extends SWCommand {
	...
	static {
		MESSAGE_HEAD = ChatColor.DARK_GRAY + "[" + ChatColor.DARK_RED + "Backups" + ChatColor.DARK_GRAY + "] ";
		BACKUP_FOLDER = TestUtils.getPluginFolder().resolve("Backups");
	}

	public BackupCommand() {
		super(new Prefix("testutils"), "backup", "bu");
	}
	...
	public void noArgsLoad(final @NotNull Player p) {
		Load.execute(null, null, BackupMode.NONE, p);
	}
	...
	public void oneArgLoad(final @NotNull Player p, final @NotNull MappedFile mappedFile) {
		Load.execute(null, mappedFile, BackupMode.NONE, p);
	}
	...
	public void twoArgsLoad(final @NotNull Player p, final @NotNull RegionSide regionSide, final @NotNull MappedFile mappedFile) {
		Load.execute(regionSide, mappedFile, BackupMode.NONE, p);
	}
	...
	public void noArgsList(final @NotNull Player p) {
		Search.execute(p, BackupMode.NONE, CaseSensitive.DENY, 1, null);
	}

	@Register("list")
	public void oneArgList(final @NotNull Player p, final @NotNull BackupMode backupMode) {
		Search.execute(p, backupMode, CaseSensitive.DENY, 1, null);
	}

	@Register("list")
	public void oneArgList(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive) {
		Search.execute(p, BackupMode.NONE, caseSensitive, 1, null);
	}

	@Register("list")
	public void oneArgList(final @NotNull Player p, final int page) {
		Search.execute(p, BackupMode.NONE, CaseSensitive.DENY, page, null);
	}

	@Register("list")
	public void twoArgsList(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull BackupMode backupMode) {
		Search.execute(p, backupMode, caseSensitive, 1, null);
	}

	@Register("list")
	public void twoArgsList(final @NotNull Player p, final @NotNull BackupMode backupMode, final int page) {
		Search.execute(p, backupMode, CaseSensitive.DENY, page, null);
	}

	@Register("list")
	public void twoArgsList(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final int page) {
		Search.execute(p, BackupMode.NONE, caseSensitive, page, null);
	}

	@Register("list")
	public void threeArgsList(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull BackupMode backupMode, final int page) {
		Search.execute(p, backupMode, caseSensitive, page, null);
	}
	...
	public void oneArgSearch(final @NotNull Player p, final @NotNull MappedFile sequence) {
		Search.execute(p, BackupMode.NONE, CaseSensitive.DENY, 1, sequence.getName());
	}

	@Register("search")
	public void twoArgsSearch(final @NotNull Player p, final @NotNull BackupMode backupMode, final @NotNull MappedFile sequence) {
		Search.execute(p, backupMode, CaseSensitive.DENY, 1, sequence.getName());
	}

	@Register("search")
	public void twoArgsSearch(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull MappedFile sequence) {
		Search.execute(p, BackupMode.NONE, caseSensitive, 1, sequence.getName());
	}

	@Register("search")
	public void twoArgsSearch(final @NotNull Player p, final @NotNull MappedFile sequence, final int page) {
		Search.execute(p, BackupMode.NONE, CaseSensitive.DENY, page, sequence.getName());
	}

	@Register("search")
	public void threeArgsSearch(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull BackupMode backupMode, final @NotNull MappedFile sequence) {
		Search.execute(p, backupMode, caseSensitive, 1, sequence.getName());
	}

	@Register("search")
	public void threeArgsSearch(final @NotNull Player p, final @NotNull BackupMode backupMode, final @NotNull MappedFile sequence, final int page) {
		Search.execute(p, backupMode, CaseSensitive.DENY, page, sequence.getName());
	}
	...
	public void threeArgsSearch(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull MappedFile sequence, final int page) {
		Search.execute(p, BackupMode.NONE, caseSensitive, page, sequence.getName());
	}

	@Register("search")
	public void fourArgsSearch(final @NotNull Player p, final @NotNull CaseSensitive caseSensitive, final @NotNull BackupMode backupMode, final @NotNull MappedFile sequence, final int page) {
		Search.execute(p, backupMode, caseSensitive, page, sequence.getName());
	}
