            ...
            if (count < 1) {
                ...
                if (pageAmount > 1) {
                    ...
                    GlobalMessageUtils.sendScrollMessage(TestBlockCommand.MESSAGE_HEAD,
                                                         "",
                                                         "",
                                                         ChatColor.DARK_PURPLE + "There is only one page of blocks and folders in this list",
                                                         ChatColor.DARK_PURPLE + "There is only one page of blocks and folders in this list", p,
                                                         ChatColor.GRAY);
                }
            }
